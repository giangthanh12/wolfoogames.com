...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-6">
            <h1><a style="font-size: 24px; color: #555555; display: inline-block; margin-right: 15px;" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a> Add new charactor</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="/content/charactor">Charactor</a></li>
                <li class="breadcrumb-item active"><strong>Add new charactor</strong></li>
            </ol>
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-9 col-12">
                            ...
                            <div class="input-group mb-3">
                                <input required type="text" class="form-control" id="title" name="title" placeholder="Charactor name" value="{{old('title')}}" />
                            </div>
                        ...
                        <div class="col-sm-3 col-12">
                            <div class="input-group mb-3">
                                ...
                                <input required type="hidden" id="icon-image" name="icon-image" value="{{old('icon-image')}}"/>
                                <div style="text-align: center; width: 100%">
                                    <div id="div-icon" style="position: relative; cursor:pointer; width: 96px; height: 96px; border: 1px solid #dddddd; border-radius: 5px; margin: auto; display: table;">
                                        <span style="font-size: 24px; color: #aaaaaa; vertical-align:middle; display: table-cell;"><i class="far fa-image"></i></span>
                                    </div>
                                    <div class="text-danger" id="icon-error">{{ $errors->first('icon-image') }}</div>
                                </div>
                            </div>
                            <div class="mb-3">
